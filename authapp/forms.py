...
class BuyerSaveForm(forms.Form):
	...
	input_first_name  	= forms.CharField(max_length = 150, required=False)
	input_second_name  	= forms.CharField(max_length = 150, required=False)
	input_phone  		= forms.CharField(max_length = 150, required=False)
